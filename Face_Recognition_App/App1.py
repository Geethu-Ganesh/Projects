...
st.sidebar.markdown("""
                    > Created by: [*Geethu*](https://github.com/Geethu-Ganesh)
                    """)

user_color      = '#0000FF'
title_webapp    = "FaceTime Streamlit Tracker"
html_temp = f"""
...
def main():
    ...
    st.sidebar.info("In the rapidly evolving field of artificial intelligence and machine learning, facial recognition technology stands at the forefront, revolutionizing various applications across industries. This project introduces a user-friendly face recognition application built using Streamlit and Python, leveraging the powerful face-recognition library. The app provides a seamless interface for users to upload images, detect faces, and perform recognition tasks with high accuracy. The integration of Streamlit ensures an interactive and intuitive user experience, allowing for real-time feedback and customization.")
